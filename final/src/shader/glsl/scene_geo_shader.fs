...
"layout (location = 1) out vec4 gView;"
...
""
"   vec3 color = global_ambient * diffuse + (h_ambient + h_diffuse + h_specular) * atten;"
""
"   gPosition = world_pos;"
"   gView = vec4(V, color.x);"
"   gNormal = vec4(N, color.y);"
"   gDiffuse = vec4(diffuse, color.z);"

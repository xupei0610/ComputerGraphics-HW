...
#define TEXTURE_BIND_HELPER(texture_id, loc, GL_LUMINANCE_or_GL_RGB,                                            \
                            repeat_mode, filtering, width, height, data, program_id, inshader_var_name)         \
    ...
    glUniform1i(glGetUniformLocation(program_id, inshader_var_name), loc);

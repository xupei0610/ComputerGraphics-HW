...
int main(int argc, char *argv[]){
	...
	while (!quit){
      while (SDL_PollEvent(&windowEvent)){
        ...
        {
            // Add by Pei Xu
            vertices[2] = 1.0f, vertices[3] = 0.0f, vertices[4] = 0.0f;
            vertices[7] = 0.0f, vertices[8] = 1.0f, vertices[9] = 0.0f;
            vertices[12]= 0.0f, vertices[13]= 0.0f, vertices[14]= 1.0f;
        }
        else if (windowEvent.type == SDL_KEYUP)
        {
			// Add by Pei Xu
            vertices[2] = rd(sd), vertices[3] = rd(sd), vertices[4] = rd(sd);
            vertices[7] = rd(sd), vertices[8] = rd(sd), vertices[9] = rd(sd);
            vertices[12]= rd(sd), vertices[13]= rd(sd), vertices[14]= rd(sd);
        }

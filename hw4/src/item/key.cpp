...
void item::Key::position(float &x, float &y, float &z)
{
    x = pos.x;
    y = pos.y;
    z = pos.z;
}
void item::Key::halfSize(float &x, float &y, float &z)
{
    x = half_scale.x;
    y = half_scale.y;
    z = half_scale.z;
...
Item *item::MetalKey::create()
{
    regItem();
    return static_cast<Item*>(new MetalKey);
}
...
Item *item::WoodKey::create()
{
    regItem();
    return static_cast<Item*>(new WoodKey);
}
...
Item *item::WaterKey::create()
{
    regItem();
    return static_cast<Item*>(new WaterKey);
}
...
Item *item::FireKey::create()
{
    regItem();
    return static_cast<Item*>(new FireKey);
}
...
Item *item::EarthKey::create()
{
    regItem();
    return static_cast<Item*>(new EarthKey);
}
